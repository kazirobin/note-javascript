...
### **4. [JavaScript Core Concepts](#javascript-core-concepts)**  
   ...
   - [4.3 Variables and Data Types](#variables-and-data-types)  
     - [4.3.1 `var`, `let`, `const`](#431-var-let-const)  
     - [4.3.2 Primitive and Reference Data Types](#432-primitive-and-reference-data-types)  
...
### **5. [JavaScript Operators](#javascript-operators)**  
   - [5.1 Assignment Operators](#51-assignment-operators)  
   ...
   - [5.6 BigInt Operators](#56-bigint-operators)  
   - [5.7 String Operators](#57-string-operators)  
   - [5.8 Conditional (Ternary) Operators](#58-conditional-ternary-operators)  
   - [5.9 Comma Operators](#59-comma-operators)  
   - [5.10 Unary Operators](#510-unary-operators)  
   - [5.11 Relational Operators](#511-relational-operators)  

### **6. [The `this` Keyword in JavaScript](#6-the-this-keyword-in-javascript)**  
   - [6.1 `this` in a Method](#61-this-in-a-method)  
   - [6.2 `this` in a Function](#62-this-in-a-function)  
   - [6.3 Using `this` Alone](#63-using-this-alone)  
   - [6.4 `this` in Event Handlers](#64-this-in-event-handlers)  
   - [6.5 `this` in Arrow Functions](#65-this-in-arrow-functions)  
   - [6.6 Explicit Binding (`call`, `apply`, `bind`)](#66-explicit-binding-call-apply-bind)  
